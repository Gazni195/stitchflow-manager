      ...
      <div className="mx-auto max-w-3xl space-y-6 p-4">
        ...
        <header className="rounded-2xl border bg-card p-5 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <span className={cn("rounded-full px-2.5 py-1 text-xs font-medium", STATUS_STYLES[card?.status ?? "idle"])}>
                    ...
                    <li key={h.id} className="rounded-xl border bg-card p-3 text-sm">
                      <div className="flex items-center justify-between">
                        <div className="font-medium">
                          {h.productionOrderCode ?? "—"} ·{" "}
                          <span className="text-muted-foreground">{h.designCode ?? "—"}</span>
                        </div>
