  ...
  public: {
    Tables: {
      ...
      materials: {
        ...
        Relationships: [
          {
            foreignKeyName: "materials_consumption_rule_id_fkey"
            columns: ["consumption_rule_id"]
            isOneToOne: false
            referencedRelation: "consumption_reduction_rules"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      production_reservations: {
        ...
        Relationships: [
          {
            foreignKeyName: "production_reservations_bundle_id_fkey"
            columns: ["bundle_id"]
            isOneToOne: false
